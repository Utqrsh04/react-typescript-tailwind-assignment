...
const Toast: FC<Props> = ({toastType, toastMessage}) => {
  return (
    <>
      {toastType === 'success' ? (
        <div
          className="bg-green-500 shadow-lg mx-auto fixed top-3 right-3 w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3"
          id="static-example"
          role="alert"
          aria-live="assertive"
          aria-atomic="true"
        ...
        <div
          className="bg-red-600 shadow-lg mx-auto fixed top-3 right-3 w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3"
          id="static-example"
          role="alert"
          aria-live="assertive"
          aria-atomic="true"
